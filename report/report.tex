...
%\begin{figure}[t]
%    \centering
%    \includegraphics[width=\linewidth]{images/sensitivity_plot.png}
...
This is an example bibliographic reference \cite{wang2026sliderquant}. If you want to add more, you must edit the file ``references.bib''.
